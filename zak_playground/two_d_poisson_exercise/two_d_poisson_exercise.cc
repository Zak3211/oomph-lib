...
int main(int argc, char* argv[]) {
        ...
        PoissonProblem<QPoissonElement<2,3>> problem(&TanhSolnForPoisson::source_function);
        ...
        TanhSolnForPoisson::TanPhi = std::stod(argv[1]);

        // Initial value for the steepness of the "step"
        TanhSolnForPoisson::Alpha = std::stod(argv[2]); 
