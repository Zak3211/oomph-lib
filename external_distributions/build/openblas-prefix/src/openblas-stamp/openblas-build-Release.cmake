...
set(command "/usr/bin/make;--jobs=8;CXX=/usr/bin/c++;CC=/usr/bin/cc;FC=/usr/bin/gfortran")
set(log_merged "ON")
set(log_output_on_failure "ON")
set(stdout_log "/home/zak3211/projects/oomph-lib/external_distributions/build/logs/openblas-build.log")
set(stderr_log "/home/zak3211/projects/oomph-lib/external_distributions/build/logs/openblas-build.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/zak3211/projects/oomph-lib/external_distributions/build/logs/openblas-build-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "openblas build command succeeded.  See also /home/zak3211/projects/oomph-lib/external_distributions/build/logs/openblas-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
