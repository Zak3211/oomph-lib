...
set(command "/usr/bin/cmake;-E;env;MAKEFLAGS=;/usr/bin/make;install")
set(log_merged "ON")
set(log_output_on_failure "ON")
set(stdout_log "/home/zak3211/projects/oomph-lib/external_distributions/build/logs/metis-install.log")
set(stderr_log "/home/zak3211/projects/oomph-lib/external_distributions/build/logs/metis-install.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/zak3211/projects/oomph-lib/external_distributions/build/logs/metis-install-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "metis install command succeeded.  See also /home/zak3211/projects/oomph-lib/external_distributions/build/logs/metis-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
