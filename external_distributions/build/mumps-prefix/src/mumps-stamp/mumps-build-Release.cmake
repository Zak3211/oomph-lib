...
set(stdout_log "/home/zak3211/projects/oomph-lib/external_distributions/build/logs/mumps-build.log")
set(stderr_log "/home/zak3211/projects/oomph-lib/external_distributions/build/logs/mumps-build.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/zak3211/projects/oomph-lib/external_distributions/build/logs/mumps-build-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "mumps build command succeeded.  See also /home/zak3211/projects/oomph-lib/external_distributions/build/logs/mumps-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
