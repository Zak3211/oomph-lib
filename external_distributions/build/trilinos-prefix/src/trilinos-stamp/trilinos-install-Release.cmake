...
set(command "/usr/bin/cmake;--install;build")
set(log_merged "ON")
set(log_output_on_failure "ON")
set(stdout_log "/home/zak3211/projects/oomph-lib/external_distributions/build/logs/trilinos-install.log")
set(stderr_log "/home/zak3211/projects/oomph-lib/external_distributions/build/logs/trilinos-install.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/zak3211/projects/oomph-lib/external_distributions/build/logs/trilinos-install-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "trilinos install command succeeded.  See also /home/zak3211/projects/oomph-lib/external_distributions/build/logs/trilinos-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
