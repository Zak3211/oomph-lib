...
set(command "/usr/bin/cmake;--build;build;-j;8")
set(log_merged "ON")
set(log_output_on_failure "ON")
set(stdout_log "/home/zak3211/projects/oomph-lib/external_distributions/build/logs/superlu-build.log")
set(stderr_log "/home/zak3211/projects/oomph-lib/external_distributions/build/logs/superlu-build.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/zak3211/projects/oomph-lib/external_distributions/build/logs/superlu-build-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "superlu build command succeeded.  See also /home/zak3211/projects/oomph-lib/external_distributions/build/logs/superlu-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
