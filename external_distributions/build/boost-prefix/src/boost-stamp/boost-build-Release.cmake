...
set(command "./b2;install;--jobs=8")
set(log_merged "ON")
set(log_output_on_failure "ON")
set(stdout_log "/home/zak3211/projects/oomph-lib/external_distributions/build/logs/boost-build.log")
set(stderr_log "/home/zak3211/projects/oomph-lib/external_distributions/build/logs/boost-build.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/zak3211/projects/oomph-lib/external_distributions/build/logs/boost-build-*.log")
  endif()
  ...
  if(NOT "Ninja" MATCHES "Ninja")
    set(msg "boost build command succeeded.  See also /home/zak3211/projects/oomph-lib/external_distributions/build/logs/boost-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
